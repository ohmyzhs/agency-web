...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    ko: {
      title: "LLM 비용 계산기",
      shortTitle: "LLM 비용",
      description: "입력·출력 토큰, 요청 수, 단가를 입력해 LLM API 사용 비용을 추정합니다.",
      seoTitle: "LLM 비용 계산기 | AI API 지출 추정",
      seoDescription: "토큰 사용량과 요청 빈도에 기반해 LLM API 비용을 투명하게 추정합니다.",
      inputs: [{ label: "토큰·단가 가정", description: "입력 토큰, 출력 토큰, 요청 수, 단가를 입력합니다." }],
      outputs: [{ label: "추정 지출", description: "1회·하루·한 달 기준 예상 비용을 표시합니다." }],
      examples: [{ label: "일간 자동화", input: "하루 1,000회 실행", output: "월간 비용 추정값" }],
      explanation: [
        "LLM 비용은 입력 토큰과 출력 토큰을 분리해 계산해야 합니다. 공급사마다 두 가격이 다르게 책정되기 때문입니다.",
      ],
      faqs: [{ question: "단가를 자동으로 가져오나요?", answer: "가져오지 않습니다. 가정을 직접 입력해 결과의 근거가 그대로 보이도록 합니다." }],
    },
  },
  {
    slug: "cron-explainer",
  ...
  },
  {
    ...
    ko: {
      title: "자동화 ROI 계산기",
      shortTitle: "ROI",
      description: "자동화가 절약하는 시간·비용 대비 구축·유지 비용이 합당한지 추정합니다.",
      seoTitle: "자동화 ROI 계산기 | 회수 기간 추정",
      seoDescription: "절약 시간, 실행 빈도, 시간당 가치, 구축 비용, 유지 비용으로 자동화 회수 기간을 계산합니다.",
      inputs: [{ label: "자동화 가정", description: "절약 시간, 빈도, 시간 단가, 구축·유지 비용을 입력합니다." }],
      outputs: [{ label: "ROI 추정", description: "회수 기간과 월간 순이득 추정값을 보여줍니다." }],
      examples: [{ label: "주간 리포트", input: "주당 2시간 절약", output: "월간 순이득 추정" }],
      explanation: ["자동화 ROI는 첫 구축 비용 외에 유지 보수와 장애 대응 비용까지 포함해야 합니다."],
      faqs: [{ question: "모든 업무를 자동화해야 할까요?", answer: "아닙니다. 빈도가 낮은 작업은 품질·리스크 측면에서 의미 있을 때만 자동화 가치가 큽니다." }],
    },
  },
  {
