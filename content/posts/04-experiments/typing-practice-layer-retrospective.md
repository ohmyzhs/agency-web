...
Zero Human Studio의 타자연습은 캐릭터나 랭킹, 커뮤니티보다 로컬 기록과 반복 연습 흐름을 먼저 선택했다. 아직 공개 랭킹이나 로그인 기능은 없다. 대신 지금 단계에서는 익명 사용자도 바로 쓸 수 있고, 브라우저 안에서 기록을 남기며, 광고나 로그인 없이 기본 연습을 할 수 있는 상태가 더 중요하다고 판단했다.
